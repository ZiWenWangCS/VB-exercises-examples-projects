Public Class Form1
    Private Sub btnBreakdown_Click(sender As Object, e As EventArgs) Handles btnBreakdown.Click
        ...
        ElseIf numberEntered < 100 Then
            ...
            Me.lblDigits.Text = "The first digit is: " & tensDigit & vbCrLf &
                "The second digit is: " & onesDigit
        ElseIf numberEntered < 1000 Then
            Call ThreeDigits(numberEntered, hundresDigit, tensDigit, onesDigit)
            Me.lblDigits.Text = "The first digit is: " & hundresDigit &
                vbCrLf & "The second digit is: " & tensDigit & vbCrLf &
    ...
    '
    'pre: num is a number lesss than 100 and greater than - 100
    'post: firstDigit stores a number between 0 and 9 inclusive.
    'secondDigit stores a number between 0 and 9 inlcusive
    '
    ...
    '
    Sub ThreeDigits(ByVal num As Integer, ByRef firstDigit As Integer, ByRef SecondDigit As Integer, ByRef thridDigit As Integer)
        firstDigit = num \ 100
        num = num Mod 100
        Call TwoDigits(num, SecondDigit, thridDigit)
    End Sub
End Class
